...
var actorChars = {
  ...
  "*": Spike //spikey ball of doom & death
};
...
var wobbleSpeed = 8, wobbleDist = 0.035;
...
var wobbleNewSpeed = 5, wobbleNewDist = 0.37;

Spike.prototype.act = function(step) {
  this.wobble += step * wobbleNewSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleNewDist;
